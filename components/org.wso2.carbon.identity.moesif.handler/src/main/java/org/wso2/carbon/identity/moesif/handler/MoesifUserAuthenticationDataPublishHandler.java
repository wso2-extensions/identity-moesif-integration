                ...
                for (String publishingDomain : publishingDomains) {
                    try {
                        ...
                        Object[] metadataArray =
                                MoesifHandlerUtils.getMetaDataArray(orgUuid, ACTION_NAME_USER_AUTHENTICATION,
                                        authenticationData.getUserId(), userAgent.orElse(NOT_AVAILABLE));

                        org.wso2.carbon.databridge.commons.Event databridgeEvent =
                                new org.wso2.carbon.databridge.commons.Event(USER_AUTHENTICATION_STREAM_NAME,
    ...
    private boolean isEnabled(Event event) throws IdentityEventException {
        ...
        if (this.configs.getModuleProperties() != null) {
            String handlerEnabled =
                    this.configs.getModuleProperties().getProperty(USER_AUTHENTICATION_PUBLISHER_ENABLED);
