...
public class MoesifRegistrationDataPublishHandlerTest {
    ...
    /**
     * When the handler is disabled (its module property is {@code "false"}), {@code handleEvent}
    ...
    /**
     * When the handler is disabled, any event name (including a completely unknown one)
    ...
    /**
     * Injects a mocked {@link ModuleConfiguration} that reports the registration publisher as
