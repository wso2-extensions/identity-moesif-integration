...
public class MoesifPublisherDTO {
    ...
    public String getMoesifOrgId() {

        return moesifOrgId;
    }

    public void setMoesifOrgId(String moesifOrgId) {

        this.moesifOrgId = moesifOrgId;
    }

    public String getMoesifAppId() {

        return moesifAppId;
    }

    public void setMoesifAppId(String moesifAppId) {

        this.moesifAppId = moesifAppId;
    }
}
